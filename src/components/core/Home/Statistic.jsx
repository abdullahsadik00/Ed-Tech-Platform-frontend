...
const Statistic = () => {
  return (
    <section className="relative py-20 overflow-hidden">
      <div className="container mx-auto px-4">
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          <p className="text-gray-600">
            Join thousands of students and institutions who trust our platform
      ...
      <div className="absolute top-0 left-0 w-1/2 h-1/2 bg-gradient-to-br from-primary/5 to-transparent -z-10" />
      <div className="absolute bottom-0 right-0 w-1/2 h-1/2 bg-gradient-to-tl from-primary/5 to-transparent -z-10" />

      {/* Decorative dots */}
      <div className="absolute top-12 right-12 w-24 h-24 bg-gradient-to-r from-primary/20 to-transparent rounded-full blur-xl" />
      <div className="absolute bottom-12 left-12 w-24 h-24 bg-gradient-to-r from-primary/20 to-transparent rounded-full blur-xl" />
    </section>
  );
};
